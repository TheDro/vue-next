...
describe('with object props', () => {
    const MyComponent = defineComponent({
        ...
        setup(props) {
            ...
            if (typeof props.iii !== 'function') {
                expectType(props.iii);
            }
            expectType(props.iii);
            expectType(true);
            expectType(props.jjj);
            expectType(props.kkk);
            expectType(props.validated);
            expectType(props.date);
    ...
    // Test TSX
    expectType(<MyComponent a={1} b="b" bb="bb" e={() => { }} cc={['cc']} dd={{ n: 1 }} ee={() => 'ee'} ccc={['ccc']} ddd={['ddd']} eee={() => ({ a: 'eee' })} fff={(a, b) => ({ a: a > +b })} hhh={false} ggg="foo" jjj={() => ''} 
    ...
    // should allow ref
    ref={'foo'}/>);
    expectType(<MyComponent b="b" dd={{ n: 1 }} ddd={['ddd']} eee={() => ({ a: 'eee' })} fff={(a, b) => ({ a: a > +b })} hhh={false} jjj={() => ''}/>);
